---
title: Home
description: Independent electronic design practice focused on RF, professional audio, industrial electronics and EMC.
---
...
- matching networks, filters and signal paths
- low-noise and power stages
- tuning, measurement and troubleshooting
- review of existing designs
- antenna interface and product integration
...
Development of electronic products from initial specifications to production release.

The service may include:

- product concept and technical specifications
- analog, digital and mixed-signal hardware
- embedded firmware integration
- prototypes and laboratory validation
...
Review and troubleshooting of electromagnetic compatibility problems during product development and laboratory testing.
...
- immunity and susceptibility troubleshooting
- filtering, grounding and shielding corrections
- on-site support during EMC laboratory tests
